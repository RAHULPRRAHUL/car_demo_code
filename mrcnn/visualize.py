...
def save_image(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    if save_dir is None:
        #save_dir = os.path.join('D:\\custum_mask_rcnn\\bone_segemtation\\', "output")
        save_dir = os.path.join('D:\\segmentation\\car_segmentation\\', "output")
    ...
    print('colors', colors)
    out_colors = []
    for col_in in colors:
        print(col_in,'col_in')
        out_colors.append((0.0, 1.0, 1.0))
        
    print('my out color', out_colors)
    colors = out_colors
    ...
    for index, value in enumerate(useful_mask_indices):
        ...
        # Label
        font = ImageFont.truetype('D:/segmentation/car_segmentation/arial.ttf', 15)
